...
#define uinf _p[1]
#define uinf_columnindex 1
#define zinf _p[2]
#define zinf_columnindex 2
#define utau _p[3]
#define utau_columnindex 3
#define ztau _p[4]
#define ztau_columnindex 4
#define gca _p[5]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cadyn /Users/hyungjaekim/Main/03 Extracurricular/RISE/project/lateral amygdala/cadyn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/hyungjaekim/Main/03 Extracurricular/RISE/project/lateral amygdala/cadyn.mod";
static const char* nmodl_file_text = 
